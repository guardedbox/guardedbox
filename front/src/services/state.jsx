 ...
 * 
 * @param {React.Component} reactComponent The React component.
 * @param {array} stateAttributesAndElements The array of names of the array attributes in the state of the component and elements or arrays of elements to add.
 *  [
 *      {
 ...
 * @param {React.Component} reactComponent The React component.
 * @param {string} stateAttribute The name of the array attribute in the state of the component.
 * @param {array} arrayIndexesAndElements The array of array indexes and elements to set.
 * @param {function} callback A callback function that will be passed to the component setState call.
 * 
 */
 ...
 * 
 * @param {React.Component} reactComponent The React component.
 * @param {array} stateAttributesAndArrayIndexesAndElements The array of names of the array attributes in the state of the component and index and element or array of array indexes and elements to set.
 *  [
 *      {
 *          stateAttribute: {string},
 *          arrayIndex: {number},
 ...
 * 
 * @param {React.Component} reactComponent The React component.
 * @param {array} stateAttributesAndArrayIndexes The array of names of array attributes and indexes or arrays of indexes to remove.
 *  [
 *      {
 *          stateAttribute: {string},
 *          arrayIndex: {number},
